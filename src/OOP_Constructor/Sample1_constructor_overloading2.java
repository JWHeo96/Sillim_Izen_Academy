...
public class Sample1_constructor_overloading2 {
	...
	public Sample1_constructor_overloading2() { //default 생성자 메소드
	}
...
//		//												 
		...
		switch(oper) {
			case "1": 
				Sample1_constructor_overloading2 scon1 = 
				new Sample1_constructor_overloading2((float)x, y);
				System.out.println(scon1.getResult() + "\n"); break;
			case "2": 
				Sample1_constructor_overloading2 scon2 = 
				new Sample1_constructor_overloading2(x, (double)y);
				System.out.println(scon2.getResult() + "\n"); break;
			case "3": 
				Sample1_constructor_overloading2 scon3 = 
				new Sample1_constructor_overloading2((double)x, y);
				System.out.println(scon3.getResult() + "\n"); break;
			case "4": 
				Sample1_constructor_overloading2 scon4 = new Sample1_constructor_overloading2((double)x, (double)y);
				System.out.println(scon4.getResult() + "\n"); break;
			case "5": 
				Sample1_constructor_overloading2 scon5 = new Sample1_constructor_overloading2(x, y);
				System.out.println(scon5.getResult() + "\n"); break;
			default: sw = false;
